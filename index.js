...
/*
request(`https://www.leaguespy.gg/league-of-legends/champion/lux/stats`, (error, response, html) => {
    ...
    if (!error && response.statusCode == 200) {
        ...
        var rune_header_pic = `https://www.leaguespy.gg${rune_primary[0].attribs.src}`;
        var rune_header_name = ($('.rune-block.rune-block--new').first().text().replace(/\s\s+/g, '!').split('!')[1]);
        var rune_keystone_pic = rune_primary[1].attribs.src;
        var rune_keystone_name = rune_primary[1].attribs.alt;
        var rune_sub1_pic = rune_primary[2].attribs.src;
        var rune_sub1_name = rune_primary[2].attribs.alt;
        var rune_sub2_pic = rune_primary[3].attribs.src;
        var rune_sub2_name = rune_primary[3].attribs.alt;
        var rune_sub3_pic = rune_primary[4].attribs.src;
        var rune_sub3_name = rune_primary[4].attribs.alt;
                                        
        //Secondary Rune
        const rune2_secondary = $('.rune-block__secondary').find('img').toArray();

        var rune2_header_pic = `https://www.leaguespy.gg${rune2_secondary[0].attribs.src}`; 
        var rune2_header_name = $('.rune-block.rune-block--new').first().text().replace(/\s\s+/g, '!').split('!')[6];               
        var rune2_sub1_pic = rune2_secondary[1].attribs.src;
        var rune2_sub1_name = rune2_secondary[1].attribs.alt;
        var rune2_sub2_pic = rune2_secondary[2].attribs.src;
        var rune2_sub2_name = rune2_secondary[2].attribs.alt;
    ...
    const app = async () => {
        ...
        const r32 = await Jimp.read(`./${rune3_2}.png`);
        const r33 = await Jimp.read(`./${rune3_3}.png`);
        //const font = await Jimp.loadFont(Jimp.FONT_);
